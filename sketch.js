...
function setup() {
	...
	box1=createSprite(500, 650, 200,20);
 	...
 	boxA = Bodies.rectangle(500, 635, 200,20 , {isStatic:true} );
 	World.add(world, boxA);

 	box2=createSprite(300, 610, 20,100);
 	box2.shapeColor=color(255,0,0);

 	boxB = Bodies.rectangle(320, 610, 20,100 , {isStatic:true} );
 	World.add(world, boxB);

 	box3=createSprite(600 , 610, 20,100);
 	box3.shapeColor=color(255,0,0);

 	boxC = Bodies.rectangle(580 , 610, 20,100 , {isStatic:true} );
